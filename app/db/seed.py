    ...
    with SyncSessionLocal() as session:
        ...
        products = [
            ...
            Product(
                ...
                description="Mouse ergonómico con batería de 6 meses",
                price=35.50,
                stock=25,
                category="Electrónica",
            ...
            Product(
                ...
                description="Switch RGB retroiluminado, diseño compacto",
                price=89.99,
                stock=15,
                category="Electrónica",
                image_url="/static/images/products/teclado.jpg",
            ),
            Product(
                ...
                stock=20,
                category="Electrónica",
                image_url="/static/images/products/audifonos.jpg",
            ),
            Product(
                name='Monitor 27" 4K',
                ...
                stock=8,
                category="Electrónica",
                image_url="/static/images/products/monitor.jpg",
            ),
            Product(
                ...
                stock=50,
                category="Ropa",
                image_url="/static/images/products/camiseta.jpg",
            ),
            Product(
                name="Chaqueta Impermeable",
                description="Capa ligera, resistente al agua",
                price=79.99,
                stock=12,
                category="Ropa",
                image_url="/static/images/products/chaqueta.jpg",
            ),
            Product(
                name="Libro: Python Avanzado",
                description="Guía completa de Python 3.13",
                price=45.00,
                stock=30,
                category="Libros",
                image_url="/static/images/products/libro.jpg",
            ),
        ]
        for p in products:
            session.add(p)
